  ...
  <div class="p-6 sm:p-8 rounded-[22px] bg-gradient-to-r from-[#4D9830] to-[#72BE4A] text-white shadow-xs relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-2xl space-y-2">
      <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 text-white text-xs font-semibold backdrop-blur-xs">
        ...
        <span>Selamat Datang, {{ auth()->user()->nama ?? 'Pengurus' }}</span>
      </span>
      <h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight">
        Portal Pengurus PawonTani
      </h1>
      <p class="text-xs sm:text-sm text-emerald-50 leading-relaxed font-medium">
        Pusat kendali dan monitoring aktivitas kelompok tani, anggota, lahan, dan hasil pertanian Anda.
      </p>
      <div class="pt-2">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
    <div class="p-5 rounded-[18px] bg-white border border-[#E4F0D6] shadow-2xs flex items-center gap-4">
      ...
      <div>
        ...
        <span class="text-[11px] text-[#4A6030] block font-medium">Anggota terdaftar</span>
      </div>
    </div>
    ...
    <div class="p-5 rounded-[18px] bg-white border border-[#E4F0D6] shadow-2xs flex items-center gap-4">
      ...
      <div>
        ...
        <span class="text-2xl font-extrabold text-[#1A2D10]">14</span>
        <span class="text-[11px] text-[#4A6030] block font-medium">Lahan aktif</span>
      </div>
    </div>
    ...
    <div class="p-5 rounded-[18px] bg-white border border-[#E4F0D6] shadow-2xs flex items-center gap-4">
      ...
      <div>
        <span class="text-xs font-semibold text-[#9AB880] uppercase tracking-wider block">Musim Tanam</span>
        <span class="text-2xl font-extrabold text-[#1A2D10]">2</span>
        <span class="text-[11px] text-[#4A6030] block font-medium">Sedang berjalan</span>
      </div>
    </div>
    ...
    <div class="p-5 rounded-[18px] bg-white border border-[#E4F0D6] shadow-2xs flex items-center gap-4">
      ...
      <div>
        <span class="text-xs font-semibold text-[#9AB880] uppercase tracking-wider block">Status Kelompok</span>
        <span class="text-2xl font-extrabold text-[#1A2D10]">Aktif</span>
        <span class="text-[11px] text-emerald-600 font-semibold block">Siap beraktivitas</span>
      </div>
    </div>
  </div>
