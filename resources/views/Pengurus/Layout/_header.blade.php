...
<header class="sticky top-0 z-30 h-16 bg-white border-b border-[#E4F0D6] flex items-center justify-between px-4 sm:px-6 lg:px-8 select-none">
  ...
  <div class="flex items-center gap-3 sm:gap-4">
    ...
    <nav class="flex items-center gap-2 text-xs sm:text-sm">
      <a href="{{ route('pengurus.dashboard') }}" class="font-medium text-[#4A6030] hover:text-[#4D9830] transition-colors">
        PawonTani
      </a>
      <i data-lucide="chevron-right" class="w-3.5 h-3.5 text-[#9AB880]"></i>
      <span data-pengurus-page-title class="font-bold text-[#1A2D10]">
    ...
    <div class="relative" data-header-dropdown>
      ...
      <div id="notification-dropdown" class="absolute right-0 top-12 z-50 hidden w-[min(22rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-[#E4F0D6] bg-white shadow-xl">
        <div class="flex items-center justify-between border-b border-[#E4F0D6] px-4 py-3">
          ...
          <span class="rounded-full bg-[#EBF6E0] px-2 py-0.5 text-[10px] font-bold text-[#4D9830]">3 baru</span>
        </div>
        <div class="max-h-[360px] divide-y divide-[#E4F0D6]/70 overflow-y-auto">
          <a href="{{ route('pengurus.anggota') }}" data-pengurus-title="Kelola Anggota" class="flex items-start gap-3 px-4 py-3 transition-colors hover:bg-[#F5F8F1]">
            ...
            <span class="min-w-0 flex-1"><span class="block text-xs font-bold text-[#1A2D10]">Anggota baru bergabung</span><span class="mt-0.5 block text-[11px] leading-relaxed text-[#6B7F5B]">Satu data anggota baru masuk.</span><span class="mt-1 block text-[10px] text-[#9AB880]">1 jam lalu</span></span>
            <i data-lucide="chevron-right" class="mt-2 h-3.5 w-3.5 shrink-0 text-[#9AB880]"></i>
          </a>
          <a href="{{ route('pengurus.dashboard') }}" data-pengurus-title="Dashboard" class="flex items-start gap-3 px-4 py-3 transition-colors hover:bg-[#F5F8F1]">
            <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-amber-50 text-amber-600"><i data-lucide="wheat" class="h-4 w-4"></i></span>
            <span class="min-w-0 flex-1"><span class="block text-xs font-bold text-[#1A2D10]">Musim panen segera</span><span class="mt-0.5 block text-[11px] leading-relaxed text-[#6B7F5B]">Persiapan panen dalam 2 minggu.</span><span class="mt-1 block text-[10px] text-[#9AB880]">3 jam lalu</span></span>
            <i data-lucide="chevron-right" class="mt-2 h-3.5 w-3.5 shrink-0 text-[#9AB880]"></i>
          </a>
          <a href="{{ route('pengurus.anggota') }}" data-pengurus-title="Kelola Anggota" class="flex items-start gap-3 px-4 py-3 transition-colors hover:bg-[#F5F8F1]">
            <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-blue-600"><i data-lucide="info" class="h-4 w-4"></i></span>
            <span class="min-w-0 flex-1"><span class="block text-xs font-bold text-[#1A2D10]">Data anggota diperbarui</span><span class="mt-0.5 block text-[11px] leading-relaxed text-[#6B7F5B]">Informasi kontak telah diubah.</span><span class="mt-1 block text-[10px] text-[#9AB880]">Kemarin</span></span>
            <i data-lucide="chevron-right" class="mt-2 h-3.5 w-3.5 shrink-0 text-[#9AB880]"></i>
          </a>
        </div>
        <a href="{{ route('pengurus.dashboard') }}" data-pengurus-title="Dashboard" class="block border-t border-[#E4F0D6] px-4 py-3 text-center text-xs font-bold text-[#4D9830] hover:bg-[#F5F8F1]">Lihat selengkapnya</a>
      </div>
    </div>
