...
@section('content')
@php
  $isAdmin = ($layout === 'Admin.Layout._layout');
  ...
  $notifications = $isAdmin
    ...
    : [
        ['icon' => 'user-plus', 'title' => 'Anggota baru bergabung', 'text' => 'Satu data anggota baru masuk ke kelompok tani.', 'time' => '1 jam lalu', 'href' => route('pengurus.anggota'), 'tone' => 'green'],
        ['icon' => 'wheat', 'title' => 'Musim panen segera tiba', 'text' => 'Persiapan panen dalam 2 minggu ke depan.', 'time' => '3 jam lalu', 'href' => route('pengurus.dashboard'), 'tone' => 'amber'],
        ['icon' => 'info', 'title' => 'Data anggota diperbarui', 'text' => 'Informasi kontak beberapa anggota telah diubah.', 'time' => 'Kemarin', 'href' => route('pengurus.anggota'), 'tone' => 'blue'],
      ];
@endphp
...
<div class="space-y-6">
  <div>
    ...
    <p class="mt-1 text-sm font-medium text-[#9AB880]">{{ $isAdmin ? 'Informasi terbaru terkait aktivitas administrasi PawonTani.' : 'Informasi terbaru terkait aktivitas kelompok tani Anda.' }}</p>
  </div>
